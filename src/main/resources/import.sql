...
INSERT INTO categorie (nom_categorie, description_categorie) VALUES( 'Categorie B', 'Dans cette categorie la puissance de la moto ne dois pas depassé les 190cc, le carbe ne doit pas etre d\'origine avec un echappement de  kit');
